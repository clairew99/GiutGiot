...
- 시간이 지남에 따라 사람들이 옷을 기억하는 시간이 줄어듦을 표현하기 위해 시간이 지날수록 모래가 내려오는 모래시계 이미지 차용
- 각 옷을 둘러싸고 있는 구슬의 크기는 사람들이 기억하는 시간의 크기를 의미
...
- 설명 구슬: 서비스가 낯선 사용자를 위해 클릭 시 앱 동작 원리 설명
<br>
...
- 입었던 옷의 남은 기억 시간, 입은 날의 대화량, 입은 날의 활동량
...
- 사용자의 편의를 위해 엄지손가락의 활동 범위 내에서 선택지 위치
