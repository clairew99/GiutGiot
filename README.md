...
2. 메인 페이지 (모래시계)
<br>
<img src="./assets/홈_화면.gif" height="300" alt="home"/>
...
3. 코디 등록
    1) 음성으로 등록
    <br><img src="./assets/음성등록.gif" height="300" alt="architecture"/><br>
    - 사용자는 음성을 통해 그날의 코디 등록 <br>
    ex: 나 오늘 빨간색 반팔 니트 입을래
    - 서비스와의 대화를 통한 등록
    
    2) 직접 등록
    <br><img src="./assets/캘린더_등록.gif" height="300" alt="architecture"/><br>
    - 45일간의 데이터 중 겹치는 코디의 주기를 분석해 사용자의 빠른 선택 지원
    - 상/하의, 색, 옷 종류를 직접 선택해 등록

4. 코디 캘린더
<br><img src="./assets/캘린더.gif" height="300" alt="architecture"/><br>
- 과거 2주일 간 코디 조회
- 픽토그램으로 색 중심 코디 표현
